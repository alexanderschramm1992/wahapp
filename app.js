...
var $author$project$Database$abilities = _List_fromArray(
	[
		...
		{
		content: $author$project$Model$Text('Smite has a warp charge value of 5. Add 1 to the warp charge value of this psychic power for each other attempt that has been made to manifest this power by a unit from your army in this phase, whether that attempt was successful or not. If manifested, the closest enemy unit within 18\'\' of and visible to the psyker suffers D3 mortal wounds. If the result of the Psychic test was 11 or more, that unit suffers D6 mortal wounds instead.'),
		...
		{
		content: $author$project$Model$Text('When a PSYKER unit attempts to deny a psychic power, you must take a Deny the Witch test for that unit by rolling 2D6. If the total is greater than the result of the Psychic test, the Deny the Witch test is passed and the psychic power is denied. Only one attempt can be made to deny a psychic power. If a PSYKER unit can attempt to deny more than one psychic power in a psychic phase, this will be listed on its datasheet.'),
		...
		{
		content: $author$project$Model$Text('If this model fires a supercharged plasma cannon, and you roll one or more hit rolls of 1, it is not automatically destroyed. Instead, for each hit roll of 1, the bearer suffers 1 mortal wound after all of this weapon\'s shots have been resolved.'),
...
var $author$project$Model$Simple = function (a) {
	return {$: 'Simple', a: a};
};
var $author$project$Model$Stratagem = {$: 'Stratagem'};
var $author$project$Database$armageddon = $elm$core$Maybe$Just(
...
var $author$project$Database$stratagems = _List_fromArray(
	[
		...
		{
		content: $author$project$Model$Text('Use this Stratagem at the start of your Charge phase. Select an ASTRA MILITARUM VEHICLE unit from your army. This unit can charge even if it Advanced this turn. In the following Fight phase, attacks made by this unit hit on a 2+.'),
		header: {
			cost: $elm$core$Maybe$Just(
		...
		{
		content: $author$project$Model$Text('Use this Stratagem at the start of your turn. Select an ASTRA MILITARUM VEHICLE from your army. It cannot move, charge or pile in this turn, but immediately heals 1 wound. You can only use this Stratagem once per turn.'),
		header: {
			cost: $elm$core$Maybe$Just(
				$author$project$Model$Simple(1)),
			faction: $elm$core$Maybe$Just($author$project$Database$astraMilitarum),
		...
		{
		content: $author$project$Model$Text('Use this Stratagem after both sides have deployed, but before the first battle round begins. Roll a dice for each enemy unit on the battlefield. On a 6, that unit suffers 1 mortal wound. You can only use this Stratagem once per battle.'),
		header: {
			cost: $elm$core$Maybe$Just(
				$author$project$Model$Simple(2)),
			faction: $elm$core$Maybe$Just($author$project$Database$astraMilitarum),
		...
		{
		content: $author$project$Model$Text('Use this Stratagem after an OFFICER from your army has issued an order or tank order. That officer may immediately issue an additional order.'),
		header: {
			cost: $elm$core$Maybe$Just(
				$author$project$Model$Simple(1)),
			faction: $elm$core$Maybe$Just($author$project$Database$astraMilitarum),
		...
		{
		content: $author$project$Model$Text('Use this Stratagem when a charge is declared against one of your ASTRA MILITARUM VEHICLE units. When that unit fires Overwatch this phase, they successfully hit on a roll of 5 or 6, instead of only 6.'),
		header: {
			cost: $elm$core$Maybe$Just(
				$author$project$Model$Simple(1)),
			faction: $elm$core$Maybe$Just($author$project$Database$astraMilitarum),
		...
		{
		content: $author$project$Model$Text('Use this Stratagem in your opponent\'s Shooting phase when your opponent selects one of your ASTRA MILITARUM INFANTRY units as a target. You can add 1 to armour saving throws you make for this unit until the end of the phase.'),
		header: {
			cost: $elm$core$Maybe$Just(
				$author$project$Model$Simple(1)),
			faction: $elm$core$Maybe$Just($author$project$Database$astraMilitarum),
		...
		{
		content: $author$project$Model$Text('Use this Stratagem before an ASTRA MILITARUM INFANTRY unit from your army shoots or fires Overwatch. Up to ten models in the unit that are armed with grenades can throw a grenade this phase, instead of only one model being able to do so.'),
		header: {
			cost: $elm$core$Maybe$Just(
				$author$project$Model$Simple(1)),
			faction: $elm$core$Maybe$Just($author$project$Database$astraMilitarum),
		...
		tags: _List_fromArray(
			[
				...
				$author$project$Model$Tag('Overwatch'),
				$author$project$Model$Tag('Infantry'),
				$author$project$Model$Tag('Grenade')
			])
	},
		{
		content: $author$project$Model$Text('Use this Stratagem at the start of the Morale phase. Pick an ASTRA MILITARUM INFANTRY unit from your army that is required to take a Morale test. You can roll a D3 for the unit, rather than a D6, when taking this test.'),
		header: {
			cost: $elm$core$Maybe$Just(
				$author$project$Model$Simple(1)),
			faction: $elm$core$Maybe$Just($author$project$Database$astraMilitarum),
		...
		{
		content: $author$project$Model$Text('Use this Stratagem at the start of your Shooting phase. Select an ARMAGEDDON INFANTRY unit from your army that disembarked from an ARMAGEDDON TRANSPORT VEHICLE this turn. You can re-roll hit rolls of 1 for that unit until the end of the phase.'),
		header: {
			cost: $elm$core$Maybe$Just(
				$author$project$Model$Simple(1)),
			faction: $elm$core$Maybe$Just($author$project$Database$astraMilitarum),
		...
		{
		content: $author$project$Model$Text('Use this Stratagem at the start of your turn. Select one VEHICLE model (except a TITANIC model) that has a damage table on its datasheet. Until the end of that turn, that model uses the top row of its damage table, regardless of how many wounds it has lost.'),
		header: {
			cost: $elm$core$Maybe$Just(
				$author$project$Model$Simple(1)),
			faction: $elm$core$Maybe$Just($author$project$Database$astraMilitarum),
		...
		{
		content: $author$project$Model$Text('Use this Stratagem in your Charge phase, when a unit from your army is chosen to charge with. Until the end of that phase, if that unit disembarked from a CHIMERA unit this turn, when making a charge roll for that unit, add 2 to the result.'),
		header: {
			cost: $elm$core$Maybe$Just(
				$author$project$Model$Simple(1)),
			faction: $elm$core$Maybe$Just($author$project$Database$astraMilitarum),
		...
		{
		content: $author$project$Model$Text('Use this Stratagem when choosing your army. Pick an ASTRA MILITARUM Detachment from your army to be an Emperor\'s Blade Specialist Detachment. COMPANY COMMANDERS, PLATOON COMMANDERS, COMMAND SQUADS, SPECIAL WEAPON SQUADS, VETERANS, INFANTRY SQUADS, CHIMERAS and TAUROXES in that Detachment gain the EMPEROR\'S BLADE keyword.'),
		header: {
			cost: $elm$core$Maybe$Just(
				$author$project$Model$Simple(1)),
			faction: $elm$core$Maybe$Just($author$project$Database$astraMilitarum),
		...
		{
		content: $author$project$Model$Text('Use this Stratagem at the end of your Movement phase. An EMPEROR\'S BLADE unit embarked within an EMPEROR\'S BLADE CHIMERA or EMPEROR\'S BLADE TAUROX can disembark. That unit cannot move further in this phase, but can otherwise act normally for the rest of the turn. That unit counts as having moved for any rules purposes, such as shooting Heavy weapons.'),
		header: {
			cost: $elm$core$Maybe$Just(
				$author$project$Model$Simple(1)),
			faction: $elm$core$Maybe$Just($author$project$Database$astraMilitarum),
		...
		header: {
			cost: $elm$core$Maybe$Just(
				$author$project$Model$Simple(1)),
			faction: $elm$core$Maybe$Nothing,
			kind: $author$project$Model$Stratagem,
			subfaction: $elm$core$Maybe$Nothing,
		...
		{
		content: $author$project$Model$Text('Use this Stratagem when a TRANSPORT model from your army is destroyed. All units that are embarked within that model can be set up wholly within 6\'\' of the destroyed model when they disembark instead of the normal 3\'\' before the model itself is removed from the battlefield. These units are not affected by the destroyed model\'s Explodes ability (or equivalent) — instead you must roll one D6 for each model you just set up on the battlefield. Instead of one model that disembarked (your choice) being destroyed for each roll of 1, one model that disembarked (your choice) is destroyed for each roll of 1 or 2. Units cannot declare a charge or perform a Heroic Intervention in the same turn that they disembarked from a destroyed TRANSPORT model.'),
		header: {
			cost: $elm$core$Maybe$Just(
				$author$project$Model$Simple(1)),
			faction: $elm$core$Maybe$Nothing,
		...
		{
		content: $author$project$Model$Text('Use this Stratagem after an enemy unit has declared a charge against one or more units from your army. One of the units that was chosen as the target of that charge can fire Overwatch before the charge roll is made.'),
		header: {
			cost: $elm$core$Maybe$Just(
				$author$project$Model$Simple(1)),
			faction: $elm$core$Maybe$Nothing,
		...
		{
		content: $author$project$Model$Text('Use this Stratagem after an enemy unit has fought in this turn. Select one of your own eligible units and fight with it next.'),
		header: {
			cost: $elm$core$Maybe$Just(
				$author$project$Model$Simple(2)),
			faction: $elm$core$Maybe$Nothing,
		...
		{
		content: $author$project$Model$Text('Use this Stratagem before you take a Morale test for a unit in your army. That test is automatically passed (do not roll any dice). You can only use this Stratagem once per battle.'),
		header: {
			cost: $elm$core$Maybe$Just(
				$author$project$Model$Simple(2)),
			faction: $elm$core$Maybe$Nothing,
...
var $author$project$Util$filterEmpty = function (maybes) {
...
var $author$project$Main$filterPair = function (pair) {
	var _v0 = pair.b;
	if (_v0.$ === 'NoMatch') {
		return $elm$core$Maybe$Nothing;
	} else {
...
var $author$project$Main$filterPairs = function (pairs) {
	return $author$project$Util$filterEmpty(
		A2($elm$core$List$map, $author$project$Main$filterPair, pairs));
};
var $author$project$Model$NoMatch = {$: 'NoMatch'};
var $author$project$Model$Match = function (a) {
	return {$: 'Match', a: a};
};
var $author$project$Main$combine = F2(
	function (result1, result2) {
		if (result1.$ === 'Match') {
			var m1 = result1.a;
			if (result2.$ === 'Match') {
				var m2 = result2.a;
				return $author$project$Model$Match(m1 + m2);
			} else {
				return $author$project$Model$Match(m1);
			}
		} else {
			if (result2.$ === 'Match') {
				var m2 = result2.a;
...
var $author$project$Main$equalsTerm = F2(
	function (text, _v0) {
		var term = _v0.a;
		var textLow = $elm$core$String$toLower(text);
		var termLow = $elm$core$String$toLower(term);
		return _Utils_eq(termLow, textLow);
	});
var $author$project$Main$matchFaction = F2(
	function (maybeFaction, terms) {
		if (maybeFaction.$ === 'Just') {
			var faction = maybeFaction.a;
			return A2(
				$elm$core$List$any,
				$author$project$Main$equalsTerm(faction.name),
				terms) ? $author$project$Model$Match(5) : $author$project$Model$NoMatch;
		} else {
			return $author$project$Model$NoMatch;
		}
	});
var $author$project$Main$startsWithTerm = F2(
	function (text, _v0) {
		var term = _v0.a;
		var textLow = $elm$core$String$toLower(text);
		var termLow = $elm$core$String$toLower(term);
		return A2($elm$core$String$startsWith, termLow, textLow);
	});
var $author$project$Main$matchHeader = F2(
	function (header, terms) {
		var titleStartsWithAnyTerm = A2(
			$elm$core$List$any,
			$author$project$Main$startsWithTerm(header.title),
			terms) ? $author$project$Model$Match(10) : $author$project$Model$NoMatch;
		var subFactionEqualsAnyTerm = A2($author$project$Main$matchFaction, header.subfaction, terms);
		var factionEqualsAnyTerm = A2($author$project$Main$matchFaction, header.faction, terms);
		return A3(
			$elm$core$List$foldl,
			$author$project$Main$combine,
			$author$project$Model$NoMatch,
			_List_fromArray(
				[titleStartsWithAnyTerm, factionEqualsAnyTerm, subFactionEqualsAnyTerm]));
	});
var $author$project$Main$matchTag = F2(
	function (text, _v0) {
		var tag = _v0.a;
		return _Utils_eq(
...
var $author$project$Main$matchTags = F2(
	function (tags, _v0) {
		var term = _v0.a;
		return A3(
			$elm$core$List$foldl,
			...
			A2(
				$elm$core$List$map,
				function (bool) {
					return bool ? $author$project$Model$Match(1) : $author$project$Model$NoMatch;
				},
				A2(
					$elm$core$List$map,
					$author$project$Main$matchTag(term),
					tags)));
	});
var $author$project$Main$matchArticle = F2(
	function (terms, article) {
		var tagsResult = A3(
			...
			A2(
				$elm$core$List$map,
				$author$project$Main$matchTags(article.tags),
				terms));
		var headerResult = A2($author$project$Main$matchHeader, article.header, terms);
		return _Utils_Tuple2(
			article,
			A2($author$project$Main$combine, tagsResult, headerResult));
	});
var $author$project$Main$matchArticles = F2(
	function (terms, articles) {
		return A2(
			$elm$core$List$map,
			$author$project$Main$matchArticle(terms),
			articles);
	});
var $elm$core$List$sortBy = _List_sortBy;
var $author$project$Main$sortPairs = function (pairs) {
...
var $author$project$Model$Term = function (a) {
	return {$: 'Term', a: a};
};
var $elm$core$String$trim = _String_trim;
var $author$project$Main$toTerms = function (text) {
	return A2(
		$elm$core$List$map,
		$author$project$Model$Term,
		A2(
			$elm$core$List$map,
	...
	function (msg, model) {
		...
		while (true) {
			switch (msg.$) {
				...
				case 'AddTag':
					var tag = msg.a.a;
					var searchText = $elm$core$String$isEmpty(model.searchText) ? tag : (model.searchText + (',' + tag));
					var searchUpdated = $author$project$Main$SearchUpdated(searchText);
					var $temp$msg = searchUpdated,
						$temp$model = model;
					msg = $temp$msg;
					model = $temp$model;
					continue update;
...
var $author$project$Main$AddTag = function (a) {
	return {$: 'AddTag', a: a};
};
...
var $author$project$Main$factionView = function (model) {
	if (model.$ === 'Just') {
		var faction = model.a;
		return A2(
			$elm$html$Html$img,
			_List_fromArray(
				[
					...
					$elm$html$Html$Attributes$alt(faction.name),
					$elm$html$Html$Attributes$class('faction-icon'),
					$elm$html$Html$Events$onClick(
					$author$project$Main$AddTag(
						$author$project$Model$Tag(faction.name)))
				]),
			_List_Nil);
	} else {
...
var $author$project$Main$articleHeaderView = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('width-80 mr-0')
					]),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('width-20')
					]),
				_List_fromArray(
					[
						$author$project$Main$factionView(model.subfaction),
						$author$project$Main$factionView(model.faction)
					]))
			]));
};
var $author$project$Main$costView = function (model) {
	return A2(
		$elm$html$Html$span,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('cost')
			]),
		_List_fromArray(
			[
				function () {
				if (model.$ === 'Just') {
					if (model.a.$ === 'Simple') {
						...
						return $elm$html$Html$text(
							$elm$core$String$fromInt(cost) + ' CP');
					} else {
						var _v1 = model.a;
						var c1 = _v1.a;
						var c2 = _v1.b;
						return $elm$html$Html$text(
							$elm$core$String$fromInt(c1) + (' CP / ' + ($elm$core$String$fromInt(c2) + ' CP')));
					}
				} else {
					return $elm$html$Html$text('');
				}
...
var $author$project$Main$articleSubHeaderView = function (model) {
	var _v0 = model.kind;
	switch (_v0.$) {
		case 'Stratagem':
			return A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Stratagem')
							])),
						$author$project$Main$costView(model.cost)
					]));
		case 'Ability':
			return A2(
				$elm$html$Html$div,
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Warlord Trait')
							]))
					]));
	}
};
...
var $author$project$Main$contentTableRowView = function (model) {
	return A2(
		$elm$html$Html$tr,
		_List_Nil,
		A2(
			...
			A2(
				...
				A2($elm$core$List$map, $elm$html$Html$text, model))));
};
var $elm$html$Html$tbody = _VirtualDom_node('tbody');
var $author$project$Main$contentTableBodyView = function (model) {
	return A2(
		$elm$html$Html$tbody,
		_List_Nil,
		A2($elm$core$List$map, $author$project$Main$contentTableRowView, model));
};
var $elm$html$Html$th = _VirtualDom_node('th');
var $elm$html$Html$thead = _VirtualDom_node('thead');
var $author$project$Main$contentTableHeaderView = function (model) {
	return A2(
		$elm$html$Html$thead,
		_List_Nil,
		$elm$core$List$singleton(
...
var $author$project$Main$contentTableView = function (model) {
	return A2(
		$elm$html$Html$table,
		_List_Nil,
		function () {
			if (!model.b) {
				...
				var headerRow = model.a;
				var rows = model.b;
				return _List_fromArray(
					[
						$author$project$Main$contentTableHeaderView(headerRow),
						$author$project$Main$contentTableBodyView(rows)
					]);
			}
		}());
};
	...
	switch (model.$) {
		...
		case 'Table':
			...
			return A2(
				...
				_List_fromArray(
					[
						$author$project$Main$contentTableView(content)
					]));
		default:
			var c1 = model.a;
			var c2 = model.b;
			return A2(
				...
				_List_fromArray(
					[
						$author$project$Main$contentView(c1),
						$author$project$Main$contentView(c2)
					]));
	}
};
var $elm$html$Html$footer = _VirtualDom_node('footer');
var $author$project$Main$tagView = function (_v0) {
	var name = _v0.a;
	return A2(
		$elm$html$Html$span,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('label mt-02 tag'),
				$elm$html$Html$Events$onClick(
				$author$project$Main$AddTag(
					$author$project$Model$Tag(name)))
			]),
		_List_fromArray(
			[
...
var $author$project$Main$articleView = function (model) {
	return A2(
		$elm$html$Html$article,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('card article')
			]),
		_List_fromArray(
			[
				$author$project$Main$articleHeaderView(model.header),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						$author$project$Main$articleSubHeaderView(model.header),
						$author$project$Main$contentView(model.content)
					])),
				A2(
				$elm$html$Html$footer,
				_List_Nil,
				A2($elm$core$List$map, $author$project$Main$tagView, model.tags))
			]));
};
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('width-80 mr'),
								$elm$html$Html$Attributes$type_('text'),
								$elm$html$Html$Attributes$placeholder('Search'),
								$elm$html$Html$Attributes$value(model.searchText),
								$elm$html$Html$Events$onInput($author$project$Main$SearchUpdated)
							]),
						_List_Nil),
						A2(
						$elm$html$Html$button,
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('flex three')
					]),
				_List_fromArray(
					[
						A2(
...
var $author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$id('view-root')
			]),
		_List_fromArray(
			[
				A2(
